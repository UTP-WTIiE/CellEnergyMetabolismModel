...
namespace CellEnergyMetabolismModel.IndividualMetabolisms.KrebsCycle.Functions
{
    ...
    {
        public static readonly double KETO_RATIO = 15;
        public static readonly double ACCOA_RATIO = 0.5 / 0.07;

        public static KrebsRates ComputeReduced(IKrebsCellState products, KrebsConstants c)
        {
            KrebsRates r = new KrebsRates();

            r.Pyr_Accoa = _rate1_1(products.Pyr, products.Accoa * ACCOA_RATIO, c.Pyr_AccoaConsts);
            r.Pyr_Oxo = _pyr_oxo_rate(products.Pyr, products.Oxo, c.Pyr_OxoConsts);
            r.AccoaOxo_Cit = _accoaOxo_cit_rate(products.Accoa * ACCOA_RATIO, products.Oxo, products.Cit, c.AccoaOxo_CitConsts);

            r.Cit_Iso = _rate1_1(products.Cit, products.Iso * KrebsProducts.cis_aco_ratio, c.Cit_IsoConsts);
            r.Iso_Keto = _rate1_1(products.Iso * KrebsProducts.iso_ratio, products.Keto * KETO_RATIO, c.Iso_KetoConsts);
            r.Keto_Sca = _rate1_1(products.Keto * KETO_RATIO, products.Sca * KrebsProducts.sca_ratio, c.Keto_ScaConsts);
        ...
        public static double ComputeRateReduced(double[] c, KrebsProducts products, int rate)
        {
            ...
            switch (rate)
            {
                case 0: r = _rate1_1(products.Pyr, products.Accoa * ACCOA_RATIO, c); break;
                case 1: r = _pyr_oxo_rate(products.Pyr, products.Oxo, c); break;
                case 2: r = _accoaOxo_cit_rate(products.Accoa * ACCOA_RATIO, products.Oxo, products.Cit, c); break;
                case 3: r = _rate1_1(products.Cit, products.Iso * KrebsProducts.cis_aco_ratio, c); break;
                case 4: r = _rate1_1(products.Iso * KrebsProducts.iso_ratio, products.Keto * KETO_RATIO, c); break;
                case 5: r = _rate1_1(products.Keto * KETO_RATIO, products.Sca * KrebsProducts.sca_ratio, c); break;
