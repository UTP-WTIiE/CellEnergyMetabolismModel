...
{
    public struct FattyAcidState : IFattyAcidsCellState
    {
        /// <summary>
        /// Beta-oxidation has differnet unit of concentration than the rest of the metabolites.
        /// Conversion rate corrects it
        /// </summary>
        public static double conversion_rate = 1000;
        ...
        public static FattyAcidState LiteratureStart()
        {
            ...
            c.C16AcylCoACYT = 1.6 / conversion_rate;
            c.C16AcylCarCYT = 0.171 / conversion_rate;
            c.C16EnoylCoAMAT = 0 / conversion_rate;
            c.C14EnoylCoAMAT = 0 / conversion_rate;
            c.C12EnoylCoAMAT = 0 / conversion_rate;
            c.C10EnoylCoAMAT = 0 / conversion_rate;
            c.C8EnoylCoAMAT = 0 / conversion_rate;
            c.C6EnoylCoAMAT = 0 / conversion_rate;
            c.C4EnoylCoAMAT = 0 / conversion_rate;
            c.AcetylCoAMAT = 30 / conversion_rate;
            c.C16AcylCarMAT = 0 / conversion_rate;
            c.C16HydroxyacylCoAMAT = 0 / conversion_rate;
            c.C14HydroxyacylCoAMAT = 0 / conversion_rate;
            c.C12HydroxyacylCoAMAT = 0 / conversion_rate;
            c.C10HydroxyacylCoAMAT = 0 / conversion_rate;
            c.C8HydroxyacylCoAMAT = 0 / conversion_rate;
            c.C6HydroxyacylCoAMAT = 0 / conversion_rate;
            c.C4HydroxyacylCoAMAT = 0 / conversion_rate;
            c.FADHMAT = 0.46 / conversion_rate;
            c.C16AcylCoAMAT = 0 / conversion_rate;
            c.C16KetoacylCoAMAT = 0 / conversion_rate;
            c.C14AcylCoAMAT = 0 / conversion_rate;
            c.C14KetoacylCoAMAT = 0 / conversion_rate;
            c.C12AcylCoAMAT = 0 / conversion_rate;
            c.C12KetoacylCoAMAT = 0 / conversion_rate;
            c.C10AcylCoAMAT = 0 / conversion_rate;
            c.C10KetoacylCoAMAT = 0 / conversion_rate;
            c.C8AcylCoAMAT = 0 / conversion_rate;
            c.C8KetoacylCoAMAT = 0 / conversion_rate;
            c.C6AcylCoAMAT = 0 / conversion_rate;
            c.C6KetoacylCoAMAT = 0 / conversion_rate;
            c.C4AcylCoAMAT = 0 / conversion_rate;
            c.C4AcetoacylCoAMAT = 0 / conversion_rate;
            c.NADHMAT = 16 / conversion_rate;
